...
\node (optimal) [box, below of=solve, yshift=-1cm,label={[align=left,xshift=-2.5cm]Optimal control using $V_x(t,x)$}] {$u^*(t,x)\in\mathop{\text{argmin}}\limits_{u}\Big\{C(t,x,u) + V_x(t,x)\cdot f\big(t,x,u\big)\Big\}$};
