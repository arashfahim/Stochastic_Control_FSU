...
\begin{frame}{Consumption}
    \begin{block}
        ...
        \[
        \inf_{c_t\ge0} \int_0^T U(c_t)\dt + S_T
        \]
        $U(c)=1-e^{-c}$. Write the HJ equation.
    \end{block}
\end{frame}
...
\begin{frame}{Consumption with discounting}
    \begin{block}
        ...
        $c_t\ge0$ is the rate of consumption.
        \[
        \inf_{c_t\ge0} \int_0^T {\color{orange}e^{-kt}}U(c_t)\dt + {\color{orange}e^{-kT}}S_T
        \]
        $U(c)=1-e^{-c}$. Write the HJ equation.
    \end{block}
\end{frame}
...
\begin{frame}{Consumption with discounting}
    \begin{block}
        ...
        \inf_{c_t\ge0} \int_0^T {\color{orange}e^{-kt}}U(c_t)\dt + {\color{orange}e^{-kT}}S_T
        \]
        $U(c)=1-e^{-c}$. Write the HJ equation by including the discounting in the DPP.
    \end{block}
\end{frame}
